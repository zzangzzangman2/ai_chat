...
export const LONG_MEMORY_SUMMARY_RULES = [
  ...
  "- 사실 신뢰도는 사용자 명시 설정·정정 > 인물별 정본 사실 > 검증된 사건 결과 > 어시스턴트 지문 순서로 적용할 것.",
  "- 어시스턴트 지문에만 나온 체형·외모·나이·직업·정체 형용사는 사건 기억으로 승격하거나 기존 정본 사실을 덮어쓰지 말 것.",
  "- 키·체중·체형·외모를 보존해야 하면 같은 문장에 그 속성 소유자의 고유명사를 반드시 쓸 것. 현재 화자·장면 초점·인물별 기억의 대상에게 다른 참여자의 신체를 옮기지 말 것.",
  "- 인물별 기억의 대상은 관계·감정 연속성을 보존할 기억 소유자이지, 사건 문장 속 모든 신체 속성의 소유자가 아님.",
  "- 키·체중·나이 같은 확정 수치와 정반대인 외형 표현을 동의어·비유로 만들지 말 것.",
  ...
  "- 호칭은 반드시 '발화자 → 수신자 → 호칭'으로 두 실명을 함께 써서 보존하고, 누가 누구를 불렀는지 역전하지 말 것.",
  ...
  "- '죽을지도 모른다', '자살할 수 있다', '죽이면', '죽이겠다' 같은 가정·가능성·협박·조건문은 실제 사망이 아니다. 절대로 사망 확정이나 '죽음 이후'로 바꾸지 말 것.",
  "- 사망은 원문에 실제로 완료된 죽음 사건이 명시된 경우에만 기록하고, 같은 인물이 이후 턴에서 말하거나 행동하면 생존 근거를 우선하여 잘못된 사망 단정을 폐기할 것.",
